  ...
  connectedCallback() {
    this.innerHTML = `
      <style>
        ...
        @import "https://cdn.jsdelivr.net/gh/davidkupyn/technischools-recruit-modal/styles.css";
      </style>
    ...
    <div id="mcsModal"
      class="relative lg:h-140 lg:w-192 flex flex-col gap-6 bg-mobile bg-cover sm:bg-desktop rounded-xl sm:py-20 sm:px-12 py-9 px-4 scale-75 transition-all ease-in-out delay-100 duration-150">
